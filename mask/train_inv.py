...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        torch.save({'state_dict':Net.state_dict()}, result_model_dir + '/' + "Inversion_m1.tar")
        torch.save({'state_dict':DG.state_dict()}, result_model_dir + '/' + "DG_m1.tar")
        torch.save({'state_dict':DL.state_dict()}, result_model_dir + '/' + "DL_m1.tar")
