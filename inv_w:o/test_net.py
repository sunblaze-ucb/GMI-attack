...
if __name__ == "__main__":
	...
	elif model_name.startswith("IR50"):
		if model_name.startswith("IR50_vib"):
			net = classify.IR50_vib(args["dataset"]["num_of_classes"])
		else:
			net = classify.IR50(args["dataset"]["num_of_classes"])
	...
	utils.load_my_state_dict(net, ckp)
